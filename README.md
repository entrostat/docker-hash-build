...
docker-hash-build/2.1.1 linux-x64 node-v20.3.0
...
_See code: [dist/commands/build.ts](https://github.com/entrostat/docker-hash-build/blob/v2.1.1/dist/commands/build.ts)_
