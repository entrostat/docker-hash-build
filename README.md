...
docker-hash-build/3.3.4 linux-x64 node-v20.3.0
...
_See code: [dist/commands/build.ts](https://github.com/entrostat/docker-hash-build/blob/v3.3.4/dist/commands/build.ts)_
