...
docker-hash-build/4.0.0 linux-x64 node-v16.20.1
...
_See code: [dist/commands/build.ts](https://github.com/entrostat/docker-hash-build/blob/v4.0.0/dist/commands/build.ts)_
